            ...
            try {
                PreparedStatement stmInsertLecturer = connection
                        .prepareStatement("INSERT INTO lecturer " +
                                "(name, designation, qualification, linkedin) " +
                ...
                return new LecturerResTo(lecturerId, lecturer.getName(),lecturer.getDesignation(),
                         lecturer.getQualification(),lecturer.getType(),pictureUrl,lecturer.getLinkedin());
            }catch (Throwable t){
                connection.rollback();
                throw t;
            }finally {
